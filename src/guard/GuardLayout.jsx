    ...
    <div className="h-screen w-screen flex bg-white overflow-hidden font-sans text-gray-800 antialiased">
      ...
      <aside className="w-64 bg-white border-r border-gray-100 flex flex-col shadow-sm shrink-0 h-full z-20">
        ...
        <div className="px-4 py-5 border-t border-gray-100 shrink-0">
          <div className="rounded-2xl p-4 text-xs flex items-center justify-between border border-gray-100 bg-gray-50">
            <div>
              <p className="text-gray-400 text-[10px] font-bold uppercase tracking-widest">
                Active Session
              </p>
              <p className="font-bold text-gray-800 mt-1 text-sm">Main Gate</p>
            </div>
      ...
      <div className="flex-1 flex flex-col h-full min-w-0 overflow-hidden">
        ...
        {/* TOP HEADER */}
        <header className="bg-white border-b border-gray-100 px-8 py-5 flex items-center justify-between shrink-0 shadow-sm z-10">
          <div>
          ...
          <div className="flex items-center gap-3 border border-gray-100 bg-gray-50 py-2 px-4 rounded-2xl shadow-sm">
            <div className="text-right">
              <p className="font-bold text-sm text-gray-800">Security Guard</p>
